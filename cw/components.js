// CloudWall 2.4.4, couchapp build 
      ...
      "lang": {
        ...
        "ru": {
          ...
          "CMD": {
            ...
            "_copy": {
              "lbl": "Копировать…",
              "tip": "Копировать или клонировать документ",
            ...
            "_overwrite": {
              "msg": "Документ уже существует в БД. Сохранение заменит существующий документ. Продолжить?",
              "go": "Перезаписать",
              "gocss": "orange",
              "success": "Документ {1} скопирован.",
              "fail": "Не удалось скопировать документ {1}."
  ...
  },
  {
    ...
    "ui": {
      ...
      if (/*v!=null && */a && Object.size(a)) {
        //build flist
        for (i in a) ao.push(Object.merge({name:i},a[i]));
